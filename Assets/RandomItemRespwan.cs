...
public class RandomItemRespwan : MonoBehaviour {
    ...
    void Start () {
        ...
        for (int i = 0; i < helletarrysize; i++)
        {
            ...
            if (n == 1)
            {
                hellet[i]= Instantiate(hellmet1, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 2)
            {
                hellet[i] = Instantiate(hellmet2, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 3)
            {
                hellet[i] = Instantiate(hellmet3, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
        }
       weapon = new GameObject[weapoarrysize];  //무기 배열
        for (int i = 0; i < weapoarrysize; i++)
        {
            ...
            if (n == 1)
            {
                weapon[i]= Instantiate(weapontype1, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 2)
            {
                weapon[i] = Instantiate(weapontype2, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 3)
            {
                weapon[i] = Instantiate(weapontype3, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 4)
            {
                weapon[i] = Instantiate(weapontype4, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 5)
            {
                weapon[i] = Instantiate(weapontype5, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
        }
       ...
       hellitem = new GameObject[hellitemarrysize]; //힐아이템 배열
        for (int i = 0; i < hellitemarrysize; i++)
        {
            ...
            if (n == 1)
            {
                hellitem[i] = Instantiate(hellitem1, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 2)
            {
                hellitem[i] = Instantiate(hellitem2, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 3)
            {
                hellitem[i] = Instantiate(hellitem3, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
        }
       drink = new GameObject[drinkarrysize]; //드링크아이템 배열
        for (int i = 0; i < drinkarrysize; i++)
        {
            ...
            if (n == 1)
            {
                drink[i] = Instantiate(drink1, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
            if (n == 2)
            {
                drink[i] = Instantiate(drink2, new Vector3(Random.Range(-34, 4.5f), Random.Range(-30, 8.8f), 0), transform.rotation);
            }
